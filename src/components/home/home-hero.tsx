...
import { HeroSeoDashboard } from "@/components/home/hero-seo-dashboard";
...
export function HomeHero() {
  return (
    <section className="relative isolate min-h-[calc(100vh-3.5rem)] overflow-hidden bg-white">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-3.5rem)] w-full max-w-6xl items-center gap-12 px-4 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 lg:py-20">
